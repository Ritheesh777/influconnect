...
import {
  ...
  IconVideo, IconFile, PLATFORM_ICON,
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="card p-6">
        ...
        {profile.bio && <p className="mt-4 text-ink-600">{profile.bio}</p>}
        <div className="mt-3 flex items-center gap-1.5 text-sm text-ink-500">
          <IconPin className="h-4 w-4" /> {[profile.city, profile.state, profile.country].filter(Boolean).join(', ') || '—'}
        </div>
      </div>
